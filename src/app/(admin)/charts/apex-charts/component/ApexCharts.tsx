...
const SplineAreaChart = () => {
  const SpilineAreaApexOpt: ApexOptions = {
    chart: {
      height: 380,
      type: 'area',
    },
...
const BasicBoxplotChart = () => {
  const BasicBoxplotOps: ApexOptions = {
    series: [
      {
        type: 'boxPlot',
        data: [
...
const ScatterBoxplotChart = () => {
  const ScatterBoxplotOps: ApexOptions = {
    series: [
      {
        name: 'Box',
        type: 'boxPlot',
...
const SimpleBubbleChart = () => {
  ...
  const simpleBubbleChartOpts: ApexOptions = {
    chart: {
      height: 380,
      type: 'bubble',
      toolbar: {
...
const Bubble3DChart = () => {
  ...
  const secondBubbleChartOpts: ApexOptions = {
    chart: {
      height: 380,
      type: 'bubble',
      toolbar: {
...
const BasicColumnChart = () => {
  const apexColumnChartOpts: ApexOptions = {
    chart: {
      height: 380,
      type: 'bar',
      toolbar: {
...
const ColumnDatalabelsChart = () => {
  const columnWithDataLableOpts: ApexOptions = {
    chart: {
      height: 380,
      type: 'bar',
      toolbar: {
...
const LineWithDataChart = () => {
  const LineWithDataLabelOps: ApexOptions = {
    chart: {
      height: 380,
      type: 'line',
      zoom: {
...
const SimpleDonutChart = () => {
  const SimpleDonutOpt: ApexOptions = {
    chart: {
      height: 320,
      type: 'donut',
    },
...
const BasicPolarChart = () => {
  const BasicPolarAreaOpt: ApexOptions = {
...
const MonochromePolarArea = () => {
  const MonochromePolarAreaOpt: ApexOptions = {
...
const BasicRadarChart = () => {
  const BasicRadarOpt: ApexOptions = {
    chart: {
      height: 350,
      type: 'radar',
    },
...
const RadarWithPolygon = () => {
  const PolygonFillOpt: ApexOptions = {
    chart: {
      height: 350,
      type: 'radar',
    },
...
const BasicRadialBarChart = () => {
  const basicRadialBarChart: ApexOptions = {
    chart: {
      height: 350,
      type: 'radialBar',
    },
...
const MultipleRadialBarsChart = () => {
  const multipleRadialBarOpts: ApexOptions = {
    chart: {
      height: 350,
      type: 'radialBar',
    },
...
const CandlestickChart = () => {
  ...
  const simpleCandlestickChartOpts: ApexOptions = {
    chart: {
      height: 400,
      type: 'candlestick',
    },
